fun main() {
    ...
    val amount = 10_000.0
    println(printResult(cardType, lastMonthAmount, amount))
}
...
fun printResult(
    ...
    return if (limit(cardType, lastMonthAmount, amount)) "ЛИМИТ ПРЕВЫШЕН"
    else "Комиссия за перевод $amount рублей по карте/счету $cardType составила " + calculateComission(
        cardType = cardType,
